  ...
  return (
    ...
    >
      <Reveal className="relative flex flex-col items-center gap-10 tablet:gap-12 laptop:block laptop:h-[640px] laptop:w-[1280px] desktop:h-[740px] desktop:w-[1512px]">
        <div className="text-espresso flex w-full max-w-[480px] flex-col items-start gap-6 laptop:absolute laptop:top-1/2 laptop:left-[40px] laptop:w-[516px] laptop:max-w-none laptop:-translate-y-1/2 desktop:left-[calc(50%-376.03px)] desktop:-translate-x-1/2">
