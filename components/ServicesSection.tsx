  ...
  return (
    ...
    >
      <Reveal className="relative flex flex-col items-center gap-16 tablet:gap-20 laptop:block laptop:h-[2187px] laptop:w-[1280px] desktop:h-[2479px] desktop:w-[1512px]">
        ...
        {/* Service 01 — white card, number above image above text pre-laptop; laptop/desktop resume the original absolute canvas */}
        <div className="bg-white flex w-full flex-col items-center gap-8 px-[10px] py-10 tablet:gap-10 tablet:py-12 laptop:contents laptop:bg-transparent laptop:p-0">
          <p className="font-sans text-center text-lg leading-normal font-medium laptop:hidden">(01)</p>
          <div className="relative w-full max-w-[420px] aspect-[330/420] overflow-hidden laptop:absolute laptop:top-[209.33px] laptop:left-[calc(50%+318px)] laptop:w-[291.36px] laptop:h-[589.33px] laptop:max-w-none laptop:aspect-auto laptop:-translate-x-1/2 desktop:top-[204.72px] desktop:left-[972.57px] desktop:w-[325.86px] desktop:h-[659.12px] desktop:translate-x-0">
            <Image
        ...
        {/* Service 02 */}
        <div className="bg-white flex w-full flex-col items-center gap-8 px-[10px] py-10 tablet:gap-10 tablet:py-12 laptop:contents laptop:bg-transparent laptop:p-0">
          <p className="font-sans text-center text-lg leading-normal font-medium laptop:hidden">(02)</p>
          <div className="relative w-full max-w-[480px] aspect-[330/390] overflow-hidden laptop:absolute laptop:top-[915.87px] laptop:left-[calc(50%-318px)] laptop:w-[636px] laptop:h-[636px] laptop:max-w-none laptop:aspect-auto laptop:-translate-x-1/2 desktop:top-[998.87px] desktop:left-[16px] desktop:w-[740px] desktop:h-[740px] desktop:translate-x-0">
            <Image
        ...
        {/* Service 03 */}
        <div className="bg-white flex w-full flex-col items-center gap-8 px-[10px] py-10 tablet:gap-10 tablet:py-12 laptop:contents laptop:bg-transparent laptop:p-0">
          <p className="font-sans text-center text-lg leading-normal font-medium laptop:hidden">(03)</p>
          <div className="relative w-full max-w-[480px] aspect-[330/390] overflow-hidden laptop:absolute laptop:top-[1551.87px] laptop:left-[calc(50%+318px)] laptop:w-[636px] laptop:h-[636px] laptop:max-w-none laptop:aspect-auto laptop:-translate-x-1/2 desktop:top-[1738.87px] desktop:left-[757px] desktop:w-[740px] desktop:h-[740px] desktop:translate-x-0">
